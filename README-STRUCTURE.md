...
- Issue definitions are synced with [GitHub Issues](https://github.com/CSA-DanielVillamizar/Tesoreriaygerenciade-negocios/issues)
...
1. Pick an issue from [GitHub Issues](https://github.com/CSA-DanielVillamizar/Tesoreriaygerenciade-negocios/issues)
...
- Issues & Bugs: [GitHub Issues](https://github.com/CSA-DanielVillamizar/Tesoreriaygerenciade-negocios/issues)
- Documentation: See [docs/README.md](docs/README.md)
- Questions: Create an [issue](https://github.com/CSA-DanielVillamizar/Tesoreriaygerenciade-negocios/issues/new) with `question` label
...
Repository: [CSA-DanielVillamizar/Tesoreriaygerenciade-negocios](https://github.com/CSA-DanielVillamizar/Tesoreriaygerenciade-negocios)
