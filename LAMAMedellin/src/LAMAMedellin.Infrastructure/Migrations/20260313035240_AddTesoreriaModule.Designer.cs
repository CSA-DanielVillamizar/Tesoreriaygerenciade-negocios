...
namespace LAMAMedellin.Infrastructure.Migrations
{
    ...
    [Migration("20260313035240_AddTesoreriaModule")]
    partial class AddTesoreriaModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LAMAMedellin.Domain.Entities.DetalleVenta", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LAMAMedellin.Domain.Entities.DetalleVenta", b =>
                {
                    b.HasOne("LAMAMedellin.Domain.Entities.Articulo", "Articulo")
                        .WithMany("DetallesVenta")
                        .HasForeignKey("ArticuloId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LAMAMedellin.Domain.Entities.Venta", "Venta")
                        .WithMany("DetallesVenta")
